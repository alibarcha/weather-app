    ...
    <header class="sticky  bg-wether-primary shadow-lg top-0">
        <nav class="container flex flex-col sm:flex-row items-center gap-4 text-white py-6 ">
            ...
            <div class="flex gap-3 flex-1 justify-end">
                <i v-on:click="toggleModal"   class="fa-solid fa-circle-info text-xl hover:text-weather-secondary duration-150 cursor-pointer"></i>
            ...
            <BaseModal v-bind:modalActive="modalActive" @close-modal="toggleModal">
              <div class="text-black">
                ...
                <p class="mb-4">The Local wether allows to track the current and future wether of cities of your choisen.</p>
